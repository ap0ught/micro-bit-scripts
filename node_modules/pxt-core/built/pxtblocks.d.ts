...
declare namespace pxt.blocks.layout {
    ...
    function svgToPngAsync(svg: SVGElement, customCss: string, x: number, y: number, width: number, height: number, pixelDensity: number): Promise<string>;
    function toSvgAsync(ws: B.Workspace): Promise<{
        width: number;
        height: number;
        xml: string;
    }>;
    function blocklyToSvgAsync(sg: SVGElement, customCss: string, x: number, y: number, width: number, height: number): Promise<{
        width: number;
        height: number;
        xml: string;
    }>;
